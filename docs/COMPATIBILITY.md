...
- **相关文件**：`src/plugin/openclaw.plugin.json`、`scripts/deploy.sh`、`environments/compat-testing/scripts/deploy-zk-to-container.sh`
...
- **相关文件**：`scripts/deploy.sh`、`scripts/setup-skill-prompt.sh`、`environments/compat-testing/scripts/deploy-zk-to-container.sh`
...
- **相关文件**：`environments/compat-testing/scripts/setup-hermes-mcp.sh`
